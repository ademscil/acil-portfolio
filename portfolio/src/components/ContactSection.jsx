...
const contactLinks = [
  {
    label: "Email",
    value: "adamjuliansyahcv@gmail.com",
    href: "mailto:adamjuliansyahcv@gmail.com",
    icon: (
  ...
  {
    label: "GitHub",
    value: "github.com/ademscil",
    href: "https://github.com/ademscil",
    icon: (
  ...
  {
    label: "LinkedIn",
    value: "Adam Juliansyah",
    href: "https://www.linkedin.com/in/adam-juliansyah-43513517b/",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="max-w-4xl mx-auto relative text-center">
        ...
        >
          ...
          <p className="text-lg text-text-secondary max-w-2xl mx-auto mb-12">
            I'm open to full-time roles, project-based work, and collaboration on 
            software development, process automation, or operational improvement.
          </p>
        </motion.div>
        ...
        >
          {contactLinks.map((link, i) => (
            <motion.a
              ...
              className="group flex items-center gap-4 p-5 rounded-2xl bg-surface-card/50 border border-border/50 hover:border-primary/40 transition-all text-left"
            >
              <div className="w-10 h-10 rounded-xl bg-primary/10 flex items-center justify-center text-primary-light group-hover:bg-primary/20 transition-colors flex-shrink-0">
                {link.icon}
              </div>
              <div>
                ...
                <div className="text-sm font-medium text-text-primary group-hover:text-primary-light transition-colors">
                  {link.value}
                </div>
              </div>
            </motion.a>
